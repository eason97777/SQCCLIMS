...
DATA_DIR = Path(os.environ.get("LIMS_DATA_DIR", ROOT / "data")).expanduser().resolve()
...
ARCHIVE_DIR = Path(os.environ.get("LIMS_ARCHIVE_DIR", DATA_DIR / "archive")).expanduser().resolve()
