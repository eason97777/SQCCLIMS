"""Logging configuration for the SQCCLIMS backend.
...
_MANAGED_ATTR = "_sqcclims_managed"
...
def setup_logging(level=logging.INFO):
    """Configure the ``sqcclims`` logger with rotating-file + stderr output.
